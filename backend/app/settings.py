...
MIDDLEWARE = [
    'django_prometheus.middleware.PrometheusBeforeMiddleware', #agregado para prometheus
    ...
    'django_prometheus.middleware.PrometheusAfterMiddleware', #agregado para prometheus
]
