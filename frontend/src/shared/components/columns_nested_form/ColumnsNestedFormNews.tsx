...
type ColumnsNestedForm = {
  ...
  clearErrors: any;
  watch: any;
  control:Control<TNewsForm>;
};



const ColumnsNestedFormNews = ({ setError, clearErrors, control, field = "columns", columnsCroppedImages, setColumnsCroppedImages, columnsImageBlobMap, setColumnsImageBlobMap, watch }: ColumnsNestedForm) => {
...
export default ColumnsNestedFormNews;
...
import { FormTColumn } from 'src/forms/TReleaseForm';
